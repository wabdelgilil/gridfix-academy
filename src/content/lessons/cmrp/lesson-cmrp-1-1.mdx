...
<StatGrid
  ...
  stats={[
    { value: '68%', label: 'وفيات الرضع', note: 'النمط F — دخل بشري بعد التركيب', color: 'rose' },
    { value: '14%', label: 'عشوائي تام', note: 'النمط E — بلا تقادم', color: 'amber' },
    { value: '7%', label: 'بداية منخفضة ثم استقرار', note: 'النمط D', color: 'teal' },
    { value: '5%', label: 'تعب وإجهاد تدريجي', note: 'النمط C', color: 'brand' },
    { value: '4%', label: 'حوض استحمام', note: 'النمط A — الكلاسيكي', color: 'ink' },
    { value: '2%', label: 'تآكل صريح مع العمر', note: 'النمط B', color: 'teal' },
  ]}
...
<StatGrid
  ...
  stats={[
    { value: '68%', label: 'Infant mortality', note: 'Pattern F — human intervention after installation', color: 'rose' },
    { value: '14%', label: 'Purely random', note: 'Pattern E — no wear-out', color: 'amber' },
    { value: '7%', label: 'Low start then stabilization', note: 'Pattern D', color: 'teal' },
    { value: '5%', label: 'Gradual fatigue and stress', note: 'Pattern C', color: 'brand' },
    { value: '4%', label: 'Bathtub', note: 'Pattern A — the classic', color: 'ink' },
    { value: '2%', label: 'Explicit wear with age', note: 'Pattern B', color: 'teal' },
  ]}
